...
export const createNotificationCampaign = (...args) => activeShopStore().createNotificationCampaign(...args);
export const getNotificationCampaign = (...args) => activeShopStore().getNotificationCampaign(...args);
export const listDueNotificationCampaigns = (...args) => activeShopStore().listDueNotificationCampaigns(...args);
export const claimNotificationCampaign = (...args) => activeShopStore().claimNotificationCampaign(...args);
export const completeNotificationCampaign = (...args) => activeShopStore().completeNotificationCampaign(...args);
export const recordNotificationClick = (...args) => activeShopStore().recordNotificationClick(...args);
